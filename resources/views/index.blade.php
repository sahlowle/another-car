...
<body dir="rtl">
    ...
    <section class="redSep col-xs-12" id="getFixed" style="position: fixed;-osition: -webkit-fixed;">
        <div class="container">
            <div class="fixedLogo">
                <img src= "/frontend/images/logo.png" width="50" alt="logo">
            </div>
            <nav class="inFixed">
                <ul>
        ...
        <div class="w-100">
            <div class="container">
                ...
                <p>الإجابة بكل إختصار : أقل الأسعار ، أفضل باقة لخدمات مابعد البيع,أكبر تنوع للسيارات في مكان واحد ،
                    جميع البنوك وشركات التمويل معتمدة لدينا ، لذلك another car هو ( خيارك الأول ومستشارك الأفضل ) لشراء
                    السيارة.</p>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="new_service">
                        <img class="new_service_bg lazyload" width="80" height="75" alt="صورة نضمن لك سيارتك الجديدة"
                            src="/frontend/images/logo.png"
                            data-src="/storage/whyus/5e4a508b250551581928587.svg">
                        <img class="new_service_bg_hover lazyload" width="80" height="75"
                            alt="صورة الوقوفنضمن لك سيارتك الجديدة" src="/frontend/images/logo.png"
                            data-src="/storage/whyus/5e4a508b25bae1581928587.svg">
                        <div class="new_service_wrap">
                            <a class="new_service_link" href="#">
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="new_service">
                        <img class="new_service_bg lazyload" width="80" height="75" alt="صورة خدمات المساعدة على الطريق"
                            src="/frontend/images/logo.png"
                            data-src="/storage/whyus/5e4a509c106f51581928604.svg">
                        <img class="new_service_bg_hover lazyload" width="80" height="75"
                            alt="صورة الوقوفخدمات المساعدة على الطريق" src="/frontend/images/logo.png"
                            data-src="/storage/whyus/5e4a509c10e841581928604.svg">
                        ...
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار اكسيد" class="lazyload" src="/frontend/images/logo.png"
                                    data-src="/storage/brands/63038e1d856e31661177373.png">اكسيد
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a
                        ...
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار بي ام دبليو" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/5ce9306fbb95e1558786159.svg">بي ام
                                دبليو
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار بيجو" class="lazyload" src="/frontend/images/logo.png"
                                    data-src="/storage/brands/616c0cd71ec4e1634471127.svg">بيجو
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار تاتا" class="lazyload" src="/frontend/images/logo.png"
                                    data-src="/storage/brands/607ac0afb85ba1618657455.png">تاتا
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار تويوتا" class="lazyload" src="/frontend/images/logo.png"
                                    data-src="/storage/brands/5cbc1b1c8fde31555831580.svg">تويوتا
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار جاي ام سي" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/63b6713042e6b1672900912.svg">جاي ام
                                سي
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار جريت وول" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/60374a584e4cd1614236248.png">جريت وول
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار جي إيه سي" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/5f5a446eed0c71599751278.png">جي إيه
                                سي
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                        ...
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار دونج فينج" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/63b985de7ca9b1673102814.svg">دونج
                                فينج
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار رام" class="lazyload" src="/frontend/images/logo.png"
                                    data-src="/storage/brands/5e513903cbefd1582381315.svg">رام
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار رنج روفر" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/5e5382d83439e1582531288.svg">رنج روفر
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار رولز رويس" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/6478d3fcbdc141685640188.svg">رولز
                                رويس
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار رينو" class="lazyload" src="/frontend/images/logo.png"
                                    data-src="/storage/brands/61754dc41016b1635077572.svg">رينو
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار زد اكس اوتو" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/62036b39c8ed01644391225.png">زد اكس
                                اوتو
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار سايك موتور" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/610e38b7ee6c71628321975.svg">سايك
                                موتور
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                        ...
                        <div class="col col-md-2 col-6 brand">
                            <a>
                                <img width="100" height="100" alt="شعار مرسيدس بنز" class="lazyload"
                                    src="/frontend/images/logo.png"
                                    data-src="/storage/brands/5cf3d0f2c58bf1559482610.svg">مرسيدس
                                بنز
                            </a>
                        </div>
                        <div class="col col-md-2 col-6 brand">
                ...
                <div class="row bankRow justify-content-center align-items-center">
                    <div class="col-6 col-md-2">
                        <img class="lazyload" width="155" height="165" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb32ecaac62d1588801226.svg"
                            alt="شعار البنك الأهلي التجاري">
                    </div>
                    <div class="col-6 col-md-2">
                        <img class="lazyload" width="155" height="165" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb313e41ebad1588794340.svg"
                            alt="شعار بنك البلاد">
                    </div>
                    <div class="col-6 col-md-2">

                        <img class="lazyload" width="155" height="165" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb31448c4a7a1588794440.svg"
                            alt="شعار بنك الرياض">
                    </div>
                    <div class="col-6 col-md-2">
                        <img class="lazyload" width="155" height="165" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb3149e192091588794526.svg"
                            alt="شعار مصرف الراجحي">
                    </div>
                    <div class="col-6 col-md-2">
                        <img class="lazyload" width="155" height="165" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb30b197b0bc1588792089.svg"
                    ...
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb3350be4e5b1588802827.svg"
                            alt="شعار إيجارة">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb3312a45f361588801834.svg"
                            alt="شعار الجبر للتمويل">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb3358c4ba6d1588802956.svg"
                            alt="شعار شركة تأجير">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb3387422f881588803700.svg"
                            alt="شعار التيسير">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb32a2ac42051588800042.svg" alt="شعار أوركس">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb32b230b41a1588800291.svg"
                            alt="شعار عبد اللطيف جميل للتمويل">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb335e7a11851588803047.svg"
                            alt="شعار شركة آجل للخدمات التمويلية">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb32fa725a7f1588801447.svg"
                            alt="شعار الأمثل للتمويل">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb33325a83f61588802341.svg"
                            alt="شعار شركة الجاسرية للتمويل">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb332e45bd5a1588802276.svg"
                            alt="شعار الخليج للتمويل">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb336e794b761588803303.svg"
                            alt="شعار شركة رافعات الخليج للتأجير التمويلي">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb3366a41f1e1588803178.svg"
                            alt="شعار السعودي الفرنسي للتمويل التأجيري">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb33772d3e551588803442.svg"
                            alt="شعار معالم للتمويل">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb3380fee4431588803599.svg"
                            alt="شعار شركة متاجر للتمويل">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb33a06908e01588804102.svg"
                            alt="شعار مرابحة للتمويل">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb34293c65311588806291.svg"
                            alt="شعار مرابحة مرنة">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb33f7fad6fe1588805503.svg"
                            alt="شعار الشركة الوطنية للتقسيط">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb340a19bd201588805793.svg"
                            alt="شعار راية للتمويل">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb3412a1cafa1588805930.svg" alt="شعار تمكين">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb3422e228491588806190.svg"
                            alt="شعار تمويل الأولى">
                    </div>
                    <div class="col-6 col-md-2 float-right">
                        <img class="lazyload" width="155" height="160" src="/frontend/images/logo.png"
                            data-src="/storage/banks/5eb341c3aaac51588806083.svg"
                            alt="شعار توكيلات">
                    </div>
